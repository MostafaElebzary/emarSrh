...
<form class="px-10" novalidate="novalidate" id="kt_form2" method="post" action="{{url('update-district')}}"
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control form-control-solid" value="{{$User->ar_title}}" name="name_ar" required
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control form-control-solid" name="name_en" value="{{$User->en_title}}" required
