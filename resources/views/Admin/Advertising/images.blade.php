        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="px-10" novalidate="novalidate" id="kt_form"  method="post" action="{{url('Create_ProductsImages')}}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-lg-12 col-xl-12">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <div class="controls">
                                            <input type="file" id="input-file-now" class="dropify" multiple  name="image[]" required data-validation-required-message="{{trans('word.This field is required')}}"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
