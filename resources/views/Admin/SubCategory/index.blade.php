                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            @inject('MainCat','App\Models\MainCategory')
                                                        <li class="breadcrumb-item">
                                                            <a href="" class="text-muted">{{$MainCat->find($id)->title}}</a>
                                                        </li>
                            ...
                            <div class="kt-section__body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        ...
                                        <input type="hidden" value="{{$id}}" class="form-control form-control-solid" name="main_category_id"  placeholder="{{__('lang.name')}}" >
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="kt_modal_4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="px-10" novalidate="novalidate" id="kt_form"  method="post" action="{{url('Create_SubCategory')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control form-control-solid" name="main_category_id" value="{{$id}}" required placeholder="{{__('lang.name_ar')}}" >
                        </div>
                        <div class="form-group">
