...
{{--                            <td>{{$user->desc}}</td>--}}
                            <td>
                                @if($user->type != 'صرف')
                                    <a class='btn btn-raised btn-outline-success btn-sml' data-placement="top" title="فاتورة ضريبيه"target="_blank" href="{{url('taxreset/'.$user->id)}}"><i class="fa fa-print"></i>&nbsp;&nbsp; فاتورة ضريبية </a>
                                @endif
