    ...
    <div class="form-group row">
        ...
        @else
            <div class="col-sm-6 form-group" style="text-align:right;padding-right:50px">
                <div>
                    ...
                    <strong> قيمه الضريبه </strong>


                    /% {{$reciept->getClient->taxepercent}}
            ...
            <div class="col-sm-6 form-group" style="text-align:right;padding-right:50px">
                <div>
                    ...
                    <strong> اجمالى الضريبه </strong>


                    / {{$reciept->amount - $reciept->total}} ر.س
            ...
            <div class="col-sm-6 form-group" style="text-align:right;padding-right:50px">
                <div>
                    ...
                    <strong> اجمالى المبلغ بدون ضريبه </strong>
        ...
        <div class="col-sm-6 form-group" style="text-align:right;padding-right:50px">
            <div>
                ...
                <strong> رقم صك </strong>

                / {{$reciept->getClient->check_num}}
            </div>
        </div>
        <div class="col-sm-6 form-group" style="text-align:right;padding-right:50px">
            <div>
